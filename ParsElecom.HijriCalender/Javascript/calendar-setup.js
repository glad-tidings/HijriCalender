...
function CalendarSetup(a, d, e, b, f, c, g, i, h) { Calendar.setup({ inputField: a, ifFormat: "%Y/%m/%d", button: d, dateType: e, weekNumbers: b, showOthers: f, firstDay: c, onSelect: g, onClose: i, onUpdate: h }) }